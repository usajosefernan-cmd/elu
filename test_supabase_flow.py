...
def test_generation_with_supabase_id():
    ...
    macro_url = "https://image-genius-3.preview.emergentagent.com/api/process/apply-user-macro"
    macro_data = {
    ...
    if macro_response.status_code == 200:
        # Now test generation
        gen_url = "https://image-genius-3.preview.emergentagent.com/api/process/generate"
        gen_data = {
            "userId": supabase_user_id,
            "input": {
